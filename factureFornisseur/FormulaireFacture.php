...
<body>
    <header>
        <div class="">
            <div style="font-size: 30px;cursor: pointer;"><a href="../easly/FactureFornisseur.php"><i class='bx bx-arrow-back' style="color: white;"></i></a></div>
        </div>
        <div class="text">
    ...
    <main>
        ...
        <div style="display: flex;justify-content: space-between;flex-wrap: wrap;">
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                <img style="height:150px;" src="../easly/LOGO.png">
                <br>
    ...
    <main class="facture-home">
        ...
        <h5 style="text-align:center;border:1px solid #ddd;margin-bottom:20px;padding:9px;text-transform: uppercase;"><span style="margin-right:10px;">Fornisseur:</span> <?php echo $row->Nom ?> <?php echo $row->Prenom ?></h5>
        </div>
