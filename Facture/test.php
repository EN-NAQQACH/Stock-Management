    ...
    <div class="main-content">
        ...
        <main>
                <form method="post">
                    ...
                    <input type="text" id="Client" oninput="selectid()" placeholder="Enter ID">

                        <div class="col-md-7">
                            <div class="form-group" style="margin-top: 20px;">
                                <label for="nomField" style="margin-bottom: 5px;">Nom</label>
                                <input type="text" id="nomField" name="Nom" autocomplete="off" readonly>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="form-group" style="margin-top: 20px;">
                                <label for="prenomField" style="margin-bottom: 5px;">Prénom</label>
                                <input type="text" id="prenomField" name="Prenom" autocomplete="off" readonly>
                            </div>
                        </div>
                    </div>
                </form>
