        ...
        <div class="modal-dialog" style="max-width: 900px;" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span class="close" data-dismiss="modal" aria-label="Close" style="cursor: pointer;font-size: 25px;"><i class='bx bx-x'></i></span>
                </div>

                <div class="row" style="margin: 20px 5px 0px 5px;">
                    <div class="col-md-12">
                        <input type="text" class="form-control" placeholder="Recherche" name="filter" id="getname">
                    </div>
                </div>
    ...
    <div class="modal fade" id="productdata" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="max-width: 900px;" role="document">
            <div class="modal-content">
                ...
                <div class="row" style="margin: 20px 5px 0px 5px;">
                    <div class="col-md-12">
                        <input type="text" class="form-control" placeholder="Recherche" name="filter" id="getproduct">
                    </div>
                </div>
                    ...
                    <div class="tables">
                        ...
                        <table class="table table-bordred" id="frmClient">
                            ...
                            <tbody>
                                <tr>
                                    <td style="border:1px solid #ddd;">
                                        <input type="text" class="form-control" name="ID_clinet" id="Client" placeholder="N° Client" data-toggle="modal" data-target="#exampleModal">
                                    </td>
                                    <td style="border:1px solid #ddd;">
                        ...
                        <table class="table table-bordred" id="frmProduct">
                            ...
                            <tbody id="myTable">
                                <tr>
                                    <td style="border:1px solid #ddd;">
                                        <input type="text" class="form-control" name="" id="Product" oninput="selectidproduct()" placeholder="N° Article" data-toggle="modal" data-target="#productdata">
                                    </td>
                                    <td style="border:1px solid #ddd;">
