...
if (isset($_POST["submit"])) {
    ...
    $sql = "SELECT c.ID, c.Nom, cmd.date FROM commandes AS cmd JOIN client AS c ON cmd.ID_Client = c.ID;";
    ...
    <h3 style="text-align:center;border:1px solid #ddd;margin-bottom:20px;padding:9px;margin-left:-37px;margin-right:-37px;">Liste des Commandes</h3>
