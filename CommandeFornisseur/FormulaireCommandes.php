                    ...
                    <div class="tables">
                        <table class="table table-hover" id="tabledatta">
                            <thead style="background-color: #e9eefd;border-radius: 50px;position: sticky;top: 0;">
                                <tr>
                                    <th scope="col" style="border:1px solid #ddd;">N° Fournisseur</th>
                            ...
                            <tbody id="showdata">
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_object($result)) { ?>
                                        <tr onclick="display(this)" id="clicked-one">
                        ...
                        <div class="tables">
                            ...
                            <table class="table table-bordred" id="frmClient">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="border:1px solid #ddd;">
                                            <input type="text" class="form-control" name="ID_fr" id="fornisseur" placeholder="Enter ID" data-toggle="modal" data-target="#exampleModal">
                                        </td>
                                        <td style="border:1px solid #ddd;">
        ...
        <script>
            ...
            jt(document).ready(function() {
                $('#getname').keyup(function() {
                    ...
                    jq.ajax({
                        method: 'post',
                        url: '../easly/searchfornisseur.php',
                        data: {
                            name: getname
                        },
