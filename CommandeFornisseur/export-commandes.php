...
$sql = "SELECT cmd.No,cmd.date, f.Nom, f.Prenom
...
$result = mysqli_query($connection, $sql);
    ...
    <div >
    <pre style="color:#241a2c;font-weight:500;"> Commandes N°: #' . $data['No'].'</pre>
    <pre style="color:#241a2c;font-weight:500;">  Date:  ' . $data['date'].'</pre>
</div>
    <h3 style="text-align:center;border:1px solid #ddd;margin-bottom:10px;padding:9px;color:#241a2c;"><span style="margin-right:6px;text-transform: uppercase;">Fornisseur:</span><span style="margin-right:1px;text-transform: uppercase;">' . $data['Nom'].'</span> <span style="text-transform: uppercase;">' .$data['Prenom']. '</span>  </h3>
    <div>
    </div>
