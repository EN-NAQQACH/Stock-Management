        ...
        <div class="sidebar-container">
            <div class="sidebar-menu">
                ...
                <ul>
                    ...
                    <li id="link-clients">
                        <a href="../php/clie.php" style="text-decoration: none">
    ...
    <div class="main-content">
        ...
        <main>
                ...
                <div style="display: flex;align-items: center;">
                    <div style="font-size: 30px;margin: -35px 20px 0 0;cursor: pointer;"><a href="../php/clie.php"><i class='bx bx-arrow-back'></i></a></div>
                    <div style="font-size: 60px;margin-top: -30px;"><i class='bx bxs-user-circle'></i></div>
                </div>
                <?php
            // Fetch the client data
            $clientData = gatClient();

            // Check if data is available
            if (!empty($clientData)) {
                $client = $clientData[0]; // Assuming only one client is fetched
            ?>
                <form style="margin-top:-50px;overflow: hidden;padding:0 15px 0 0;" method="post" action="../client/UpdateData.php">
                    <div class="row" style="flex-direction: column;align-items: center;">
                        ...
                        <div class="col-md-7">
                            <div class="form-group" style="margin-top: 20px;">
                                ...
                                <input type="Adresse" class="form-control" id="formGroupExampleInput4" placeholder="Adresse" name="Adress" autocomplete="off" value="<?php echo $client['Address']; ?>">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="form-group" style="margin-top: 20px;">
