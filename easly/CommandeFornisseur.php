    ...
    <div class="main-content">
        ...
        <main>
            ...
            <section class="home-table">
                ...
                <form action="../CommandeFornisseur/export-list-commandes.php" method="post" style="margin-top: 12px;">
                    <a href="../CommandeFornisseur/FormulaireCommandes.php"><button type="button" class="btn btn-primary" data-toggle="modal" id="btnedit" data-target="#fullcontent">Ajouter</button></a>
                ...
                ">
                            <tr>
                                <th scope="col" style="border:1px solid #ddd;">N° Commande</th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <div style="display: flex;justify-content: space-around;align-items: center;">
                                                <a href="../CommandeFornisseur/Formulaire de Modification.php?id=<?php echo $row->No; ?>" style="text-decoration: none;color: black;font-size: 1.2rem;" title="edit"><i class='bx bx-pencil'></i></a>
                                                <form action="../CommandeFornisseur/Display_commandes.php" method="post">
                                                    <a href="../CommandeFornisseur/Display_commandes.php?id=<?php echo $row->No; ?>" style="text-decoration: none;color:green;font-size: 1.2rem;"><i class='bx bxs-show'></i></a>
                                                </form>
                                                <a href="../CommandeFornisseur/DeleteData.php?id=<?php echo $row->No; ?>" style="text-decoration: none;color: red;font-size: 1.2rem;"><i class='bx bx-x-circle'></i></a>
                                                <a href="../CommandeFornisseur/export-commandes.php?id=<?php echo $row->No; ?>" style="text-decoration: none;color:black;font-size: 1.2rem;"><i class='bx bxs-printer'></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php }
                            } else {
                                $resetQuery = "ALTER TABLE commandesfornissuer AUTO_INCREMENT = 1";
