    ...
    <div class="main-content">
        ...
        <main>
                ...
                <div style="display: flex;align-items: center;">
                    <div style="font-size: 30px;margin: -35px 20px 0 0;cursor: pointer;"><a href="../easly/Fornisseur.php"><i class='bx bx-arrow-back'></i></a></div>
            ...
            ?>
                <form style="margin-top:-50px;overflow: hidden;padding:0 15px 0 0;" method="post" action="../Fornisseur/UpdateData.php">
            ...
            <?php
                ...
                // No fournisseur data found
                echo "Fornisseur not found";
            }
            ?>
        </main>
    </div>
